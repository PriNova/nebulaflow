...
### Goal: LLM Property Editor – Builtin Tools Accordion and Master Toggle

- Changed: Replaced the LLM node "Tools" chip cloud in `workflow/Web/components/sidebar/widgets/ToolsSelector.tsx` with a shadcn-based accordion section labeled "Builtin tools", rendering each builtin tool as its own checkbox row backed by the existing `disabledTools` data model so enable/disable semantics remain unchanged.
- Added: Introduced a master checkbox in the accordion header that toggles all builtin tools on or off in one action, implemented via `onToggleAll`, and ensured that turning all tools off also clears `dangerouslyAllowAll` to preserve the Bash safety invariant used by the backend.
- Changed: Applied a small visual tweak to the library buttons in `workflow/Web/components/sidebar/WorkflowSidebar.tsx` by adding `tw-text-sm` to the shared `libraryButton` class for slightly smaller, more consistent text in the left sidebar library.
- Why: Makes builtin tool configuration in the LLM Property Editor more compact and scalable, adds an explicit bulk-toggle control that respects existing safety guards, and keeps the library sidebar typography consistent with the rest of the UI.
...
### Goal: Refactor Large TypeScript Files into Vertical Slice Modules

- Changed: Split three largest files into focused modules to align with Vertical Slice Architecture and improve maintainability and testability.
  - Flow.tsx → extracted canvas, layout containers, overlays, effect hooks, and pure utils:
    - Canvas: [FlowCanvas.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/canvas/FlowCanvas.tsx)
    - Layout: [LeftSidebarContainer.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/layout/LeftSidebarContainer.tsx), [RightSidebarContainer.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/layout/RightSidebarContainer.tsx)
    - Overlays: [QuickActions.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/overlays/QuickActions.tsx), [SubflowOutputsEditor.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/overlays/SubflowOutputsEditor.tsx)
    - Effects: [useEditNode.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/effects/useEditNode.ts), [useRunFromHere.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/effects/useRunFromHere.ts), [useRunOnlyThis.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/effects/useRunOnlyThis.ts), [useDuplicateSubflow.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/effects/useDuplicateSubflow.ts)
    - Subflows: [useOpenSubflow.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/subflows/useOpenSubflow.ts), [useProvideSubflow.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/subflows/useProvideSubflow.ts), [useSubflowState.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/subflows/useSubflowState.ts), [useSaveSubflow.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/subflows/useSaveSubflow.ts)
    - Utils: [deepClone.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/utils/deepClone.ts), [pruneEdges.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/utils/pruneEdges.ts)
    - Result: Flow.tsx size reduced significantly with orchestration-only responsibility.
  - PropertyEditor.tsx → extracted node-specific panels and reusable widgets:
    - Properties: [CLIProperties.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/properties/CLIProperties.tsx), [LLMProperties.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/properties/LLMProperties.tsx), [InputProperties.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/properties/InputProperties.tsx), [PreviewProperties.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/properties/PreviewProperties.tsx), [LoopStartProperties.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/properties/LoopStartProperties.tsx), [AccumulatorProperties.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/properties/AccumulatorProperties.tsx), [VariableProperties.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/properties/VariableProperties.tsx), [IfElseProperties.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/properties/IfElseProperties.tsx)
    - Widgets: [LLMTimeoutField.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/widgets/LLMTimeoutField.tsx), [ModelSelector.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/widgets/ModelSelector.tsx), [ToolsSelector.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/widgets/ToolsSelector.tsx)
    - Result: PropertyEditor now acts as a thin switchboard.
  - ExecuteWorkflow.ts → extracted node runners and pure execution helpers:
    - Node runners: [run-llm.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Application/node-runners/run-llm.ts), [run-cli.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Application/node-runners/run-cli.ts), [run-preview.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Application/node-runners/run-preview.ts), [run-input.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Application/node-runners/run-input.ts), [run-if-else.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Application/node-runners/run-if-else.ts), [run-loop-start.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Application/node-runners/run-loop-start.ts)
    - Subflow execution: [run-subflow.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Application/subflow/run-subflow.ts)
    - Core execution (pure): [inputs.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Core/execution/inputs.ts), [combine.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Core/execution/combine.ts), [graph.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Core/execution/graph.ts), [sanitize.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowExecution/Core/execution/sanitize.ts)
    - Result: ExecuteWorkflow.ts reduced to orchestration and routing; pure helpers isolated for unit testing.
- Why: Improves maintainability (single responsibility), testability (pure Core helpers), and extensibility (add node types or property panels without touching orchestrators); aligns with VSA and CQRS separation inside the slice.


### Goal: Input/Results Editor Switch + Unified Modal Sizing/Semantics

- Added: From the input editor, a "Switch to Results" control dispatches a lightweight UI event to open the results editor for the same node; closes the input modal for a clean handoff. See [TextEditorModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/TextEditorModal.tsx) and dispatch sites in node components: [CLI_Node.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/nodes/CLI_Node.tsx), [LLM_Node.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/nodes/LLM_Node.tsx), [Text_Node.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/nodes/Text_Node.tsx), [Variable_Node.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/nodes/Variable_Node.tsx).
- Added: From the results editor, a "Switch to Input" control dispatches the existing edit event to reopen the input editor for the same node. See [CombinedPreviewEditorModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/CombinedPreviewEditorModal.tsx) and handler wiring in [RightSidebar.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/RightSidebar.tsx).
- Changed: Unified modal layout (same max width, ~95vw width, ~90vh height, shared header structure) across input and results editors. See [TextEditorModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/TextEditorModal.tsx) and [CombinedPreviewEditorModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/CombinedPreviewEditorModal.tsx).
- Changed: Unified footer semantics to "Close" (dismiss) and "Save" (persist) for consistency. See [TextEditorModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/TextEditorModal.tsx) and [CombinedPreviewEditorModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/CombinedPreviewEditorModal.tsx).
- Added: RightSidebar now listens for `nebula-open-result-editor` events to open the combined results editor for a given node id; also wires back to input via the existing `nebula-edit-node` event. See [RightSidebar.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/RightSidebar.tsx).

Why: Improves UX by allowing quick switching between input and results for the same node without centralizing modal ownership; reduces cognitive load through consistent sizing and footer semantics; leverages existing events for minimal, explicit wiring.

### Goal: Webview UI Sliced by Feature + Standardized Imports + TS Noise Mitigation

- Changed: Moved webview components into feature slices and updated imports to use aliases for clarity and maintainability:
  - Sidebar: [sidebar/LeftSidebar.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/LeftSidebar.tsx), [sidebar/RightSidebar.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/RightSidebar.tsx), [sidebar/WorkflowSidebar.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/WorkflowSidebar.tsx), [sidebar/PropertyEditor.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/PropertyEditor.tsx), [sidebar/SidebarActionsBar.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/sidebar/SidebarActionsBar.tsx)
  - Graph: [graph/CustomOrderedEdge.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/graph/CustomOrderedEdge.tsx), [graph/edges/edgePaths.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/graph/edges/edgePaths.ts), [graph/utils/edgeValidation.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/graph/utils/edgeValidation.ts)
  - Modals: [modals/HelpModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/HelpModal.tsx), [modals/TextEditorModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/TextEditorModal.tsx), [modals/MarkdownPreviewModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/MarkdownPreviewModal.tsx), [modals/ConfirmDeleteWorkflowModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/ConfirmDeleteWorkflowModal.tsx), [modals/CombinedPreviewEditorModal.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/modals/CombinedPreviewEditorModal.tsx)
  - Shared UI: [shared/CopyToClipboardButton.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/shared/CopyToClipboardButton.tsx), [shared/NebulaSpinningLogo.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/shared/NebulaSpinningLogo.tsx), [shared/Markdown.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/shared/Markdown.tsx), [shared/RunFromHereButton.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/shared/RunFromHereButton.tsx), [shared/RunOnlyThisButton.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/shared/RunOnlyThisButton.tsx), and [shared/index.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/shared/index.ts)
  - Call sites updated (e.g., [Flow.tsx](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/Flow.tsx), hooks under [components/hooks](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/hooks), and nodes under [components/nodes](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/nodes)) to use the new aliases
- Added: Path aliases for cleaner imports in both TypeScript and Vite configs:
  - TS paths in [workflow/Web/tsconfig.json](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/tsconfig.json) for `@graph/*`, `@sidebar/*`, `@modals/*`, `@nodes/*`, `@shared/*`
  - Vite resolve aliases in [workflow/Web/vite.config.mts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/vite.config.mts) mirroring the TS paths
- Changed: Converted remaining relative imports to use the new aliases across the webview codebase; behavior preserved
- Changed: Standardized shared component imports via the new barrel [shared/index.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/shared/index.ts)
- Changed: Mitigated forward-looking TypeScript deprecation noise by adding `ignoreDeprecations: "6.0"` at the root of [workflow/Web/tsconfig.json](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/tsconfig.json)
- Why: Aligns the webview with Vertical Slice Architecture for clearer feature ownership, reduces brittle relative paths via aliases, and keeps builds/typechecks clean by suppressing future TS deprecation warnings without affecting current types.

### Goal: Slice Workflow Into Fine-Grained Slices + Router Cleanup

- Changed: Introduced slice-based routing and registration to replace legacy switch handling in [register.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Application/register.ts#L109-L117), delegating to slice registries:
  - [LLMIntegration register](file:///home/prinova/CodeProjects/nebulaflow/workflow/LLMIntegration/Application/register.ts#L8-L26)
  - [Library register](file:///home/prinova/CodeProjects/nebulaflow/workflow/Library/Application/register.ts#L18-L63)
  - [Subflows register](file:///home/prinova/CodeProjects/nebulaflow/workflow/Subflows/Application/register.ts#L47-L89)
  - [WorkflowPersistence register](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowPersistence/Application/register.ts#L43-L142)
- Removed: Legacy message cases for get_subflows, duplicate_subflow, get_models, get_storage_scope, toggle_storage_scope, save_workflow, load_workflow (stub left), open_external_link, save_customNode, get_custom_nodes, delete_customNode, rename_customNode from [register.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Application/register.ts#L125-L139). These are now handled exclusively via the slice router.
- Changed: Added `router.clear()` in webview panel `onDidDispose` to release closures and avoid stale handlers in [register.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Application/register.ts#L402-L404).
- Changed: Tightened `open_external_link` to restrict file-like URIs to workspace files only in [WorkflowPersistence register](file:///home/prinova/CodeProjects/nebulaflow/workflow/WorkflowPersistence/Application/register.ts#L110-L115).
- Changed: Minor import path and type-safety cleanups during the slice extraction, including moving `safePost`/`workspace` helpers under Shared Infrastructure and aligning imports in [nodeStateTransforming.ts](file:///home/prinova/CodeProjects/nebulaflow/workflow/Web/components/hooks/nodeStateTransforming.ts#L1-L6).

Why: Aligns with Vertical Slice Architecture, reduces duplicate handling and drift risk, and improves lifecycle hygiene by releasing router handlers when the panel is disposed. Security is improved by restricting file link handling to workspace paths.
...
### Goal: Workflow Node Copy/Paste and Clipboard Integration
...
### Goal: Copy/Paste Preserves Node Results and LLM Threads
