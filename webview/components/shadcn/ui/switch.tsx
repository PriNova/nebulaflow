...
>(({ className, ...props }, ref) => (
    <SwitchPrimitives.Root
        className={cn(
            'tw-peer tw-inline-flex tw-h-8 tw-w-14 tw-shrink-0 tw-cursor-pointer tw-items-center tw-rounded-full',
    ...
    >
        <SwitchPrimitives.Thumb
            className={cn(
                styles['switch-thumb'],
                'tw-pointer-events-none tw-block tw-h-6 tw-w-6 tw-rounded-full tw-bg-background tw-shadow-lg tw-ring-0 tw-transition-transform data-[state=checked]:tw-translate-x-5 data-[state=unchecked]:tw-translate-x-0'
            )}
        />
    </SwitchPrimitives.Root>
))
