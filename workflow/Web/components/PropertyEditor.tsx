                                ...
                                {(['bash', 'sh', 'zsh'] as const).includes(
                                    ...
                                    <div className="tw-flex tw-items-center tw-gap-3">
                                        ...
                                        <div className="tw-flex tw-items-center tw-space-x-1">
                                            ...
                                            />
                                            <Label htmlFor={`flag-pipe-${node.id}`}>
                                                set -o pipefail
                                            </Label>
                                        </div>
                                    </div>
                                    ...
                                    <div className="tw-flex tw-items-center tw-gap-3">
                                        ...
                                        <div className="tw-flex tw-items-center tw-space-x-1">
                                            <Checkbox
                                                id={`flag-ni-${node.id}`}
                                                checked={
                                                    (node as any).data?.flags?.nonInteractive !== false
                                                }
                                                onCheckedChange={checked =>
                                                    onUpdate(node.id, {
                                                        flags: {
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-2">
                        ...
                        <div className="tw-flex tw-items-center tw-gap-3">
                            <div className="tw-flex tw-items-center tw-space-x-1">
                                ...
                                />
                                <Label htmlFor={`env-expose-${node.id}`}>
                                    Expose parents as INPUT_1…N
                                </Label>
                            </div>
                        </div>
                        {showAdvanced && (
                            <>
                                ...
                                <div>
                                    <Label htmlFor={`env-static-${node.id}`}>
                                        Static env (JSON object)
                                    </Label>
                                    <Textarea
